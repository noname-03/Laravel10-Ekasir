@extends('layouts.app')
@section('title', 'Perbarui Data Item')
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Perbarui Data Item</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" style="display: block;">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('item.update', $itemProduct->id) }}" method="post"
                                    ...
                                    <div class="form-row">
                                            ...
                                            <select class="form-control selectpicker" name="category_id"
                                                ...
                                                @foreach ($categories as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $itemProduct->category_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->title }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control selectpicker" name="unit_id" data-live-search="true"
                                                ...
                                                @foreach ($units as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $itemProduct->unit_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->title }}</option>
                                                @endforeach
                                            </select>
                                            @error('unit_id')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control  @error('title') is-invalid @enderror"
                                                ...
                                                value="{{ old('title', $itemProduct->title) }}">
                                            @error('title')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control  @error('price') is-invalid @enderror"
                                                ...
                                                value="{{ old('price', $itemProduct->price) }}">
                                            @error('price')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control  @error('stock') is-invalid @enderror"
                                                ...
                                                value="{{ old('stock', $itemProduct->stock) }}">
                                            @error('stock')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
